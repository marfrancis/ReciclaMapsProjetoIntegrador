...
<h2 class="mt-4 mb-4"> TERMOS DE SERVIÇO </h2>



<H3>VISÃO GERAL</H3>

<p>Esse site é operado pelo Reeduca Recicla. Em todo o site, os termos “nós”, “nos” e “nosso” se referem ao Reeduca Recicla. O Reeduca Recicla proporciona esse site, incluindo todas as informações, ferramentas e serviços disponíveis deste site para você, o usuário, com a condição da sua aceitação de todos os termos, condições, políticas e avisos declarados aqui.
...
Nossa loja é hospedada no Shopify Inc. Eles nos fornecem uma plataforma de e-commerce online que nos permite vender nossos produtos e serviços.</p>

<h4 class="mt-4 mb-4">SEÇÃO 1 - TERMOS DA LOJA VIRTUAL</h4>

<p>Ao concordar com os Termos de serviço, você confirma que você é maior de idade em seu estado ou província de residência e que você nos deu seu consentimento para permitir que qualquer um dos seus dependentes menores de idade usem esse site.
...
<h4 class="mt-4 mb-4">SEÇÃO 2 - CONDIÇÕES GERAIS</h4>
...
<h4 class="mt-4 mb-4">SEÇÃO 3 - PRECISÃO, INTEGRIDADE E ATUALIZAÇÃO DAS INFORMAÇÕES</h4>
...
<h4 class="mt-4 mb-4">SEÇÃO 4 - MODIFICAÇÕES DO SERVIÇO E PREÇOS</h4>
...
Não nos responsabilizados por você ou por qualquer terceiro por qualquer modificação, alteração de preço, suspensão ou descontinuação do Serviço.</p>


<h4 class="mt-4 mb-4">SEÇÃO 5 - PRODUTOS OU SERVIÇOS (caso aplicável)</h4>

<p>Certos produtos ou serviços podem estar disponíveis exclusivamente online através do site. Tais produtos ou serviços podem ter quantidades limitadas e são sujeitos a apenas devolução ou troca, de acordo com nossa Política de devolução.
...
<h4 class="mt-4 mb-4">SEÇÃO 6 - PRECISÃO DE INFORMAÇÕES DE FATURAMENTO E CONTA</h4>
...
<h4 class="mt-4 mb-4">SEÇÃO 7 - FERRAMENTAS OPCIONAIS</h4>
...
Também podemos, futuramente, oferecer novos serviços e/ou recursos através do site (incluindo o lançamento de novas ferramentas e recursos). Tais recursos e/ou serviços novos também devem estar sujeitos a esses Termos de serviço.</p>


<h4 class="mt-4 mb-4">SEÇÃO 8 - LINKS DE TERCEIROS</h4>
...
Não somos responsáveis por quaisquer danos ou prejuízos relacionados com a compra ou uso de mercadorias, serviços, recursos, conteúdo, ou quaisquer outras transações feitas em conexão com quaisquer sites de terceiros. Por favor, revise com cuidado as políticas e práticas de terceiros e certifique-se que você as entende antes de efetuar qualquer transação. As queixas, reclamações, preocupações ou questões relativas a produtos de terceiros devem ser direcionadas ao terceiro.</p>


<h4 class="mt-4 mb-4">SEÇÃO 9 - COMENTÁRIOS, FEEDBACK, ETC. DO USUÁRIO</h4>
...
<h4 class="mt-4 mb-4">SEÇÃO 10 - INFORMAÇÕES PESSOAIS</h4>
...
<h4 class="mt-4 mb-4">SEÇÃO 11 - ERROS, IMPRECISÕES E OMISSÕES</h4>
...
<h4 class="mt-4 mb-4">SEÇÃO 12 - USOS PROIBIDOS</h4>
...
<h4 class="mt-4 mb-4">SEÇÃO 13 - ISENÇÃO DE RESPONSABILIDADE DE GARANTIAS; LIMITAÇÃO DE RESPONSABILIDADE</h4>

<p>Nós não garantimos, representamos ou justificamos que o seu uso do nosso serviço será pontual, seguro, sem erros ou interrupções.
...
<h4 class="mt-4 mb-4">SEÇÃO 16 - RESCISÃO</h4>

<p>As obrigações e responsabilidades das partes incorridas antes da data de rescisão devem continuar após a rescisão deste acordo para todos os efeitos.
...
<h4 class="mt-4 mb-4">SEÇÃO 17 - ACORDO INTEGRAL</h4>

<p>Caso não exerçamos ou executemos qualquer direito ou disposição destes Termos de serviço, isso não constituirá uma renúncia de tal direito ou disposição.
...
<h4 class="mt-4 mb-4">SEÇÃO 18 - LEGISLAÇÃO APLICÁVEL</h4>

<p>Esses Termos de serviço e quaisquer acordos separados em que nós lhe fornecemos os Serviços devem ser regidos e interpretados de acordo com as leis de Rua Dr. Cardoso de Melo 90, Sao Paulo, SP, 09521160, Brazil.</p>


<h4 class="mt-4 mb-4">SEÇÃO 19 - ALTERAÇÕES DOS TERMOS DE SERVIÇO</h4>
...
<h4 class="mt-4 mb-4">SEÇÃO 20 - INFORMAÇÕES DE CONTATO</h4>

<p>As perguntas sobre os Termos de serviço devem ser enviadas para nós através do reeducarecicla@gmail.com.</p>
