...
$foto = 'mapahome.png';
$title = $facebook_title = "Registro de Usuário";
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="sobrenome" type="text"
                                            ...
                                            autocomplete="sobrenome" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="data_nascimento" type="date"
                                            ...
                                            autocomplete="data_nascimento" style="font-style:italic">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="telefone" type="number"
                                            ...
                                            mask="(__) _____-____" placeholder="Ex: (xx) xxxx-xxxx"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="cep" type="text"
                                            ...
                                            autocomplete="cep" mask="_____-___" placeholder="Ex: xxxxx-xxx"
                                            style="font-style:italic">
                                        @error('cep')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
